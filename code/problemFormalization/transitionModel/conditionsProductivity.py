...
map_condition_productivity  = { 
        ...
        'Corn': {
            'poor': random.uniform (5,40),
            'below average': random.uniform (40,80),
            'average': random.uniform (80,100),
            'above average':random.uniform (100,120),
            'ideal': random.uniform(120,200)
        },
        'Dates': {
            'poor': random.uniform (5,20),
